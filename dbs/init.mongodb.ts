...
const connectString = 'mongodb+srv://nguyenminhtri:200420022015tT@cluster0.elutv7g.mongodb.net/'
...
class Databasse {
    ...
    connect(type = 'mongodb') {
        ...
        mongoose.connect(connectString).then(() => console.log("Connect Sucessfully"))
