...
router.get('/rate/getAllByUserId', asyncHandler(rateController.getallRateByUserId))
router.get('/rate/getAllByAccommodation', asyncHandler(rateController.getRateByAccommodation));
