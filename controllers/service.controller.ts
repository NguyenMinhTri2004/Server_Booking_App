...
class ServiceController {
  ...
  updateService = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ServiceService.update(
  ...
  deleteServiceType = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ServiceTypeService.delete({
  ...
  getServiceType = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ServiceTypeService.get({
  ...
  updateServiceType = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ServiceTypeService.update(
        { serviceTypeId: req.body.serviceTypeId },
        { ...req.body }
      ),
    }).send(res);
