...
class ConvenientController {
  ...
  getConvenient = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ConvenientService.get({
        typeConvenientId: req.query.typeConvenientId
      }),
    }).send(res);
  };
  ...
  updateConvenient = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ConvenientService.update(
  ...
  deleteConvenient = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ConvenientService.delete({
        convenientId: req.body.convenientId,
      }),
    }).send(res);
  };
  ...
  deleteConvenientType = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ConvenientTypeService.delete({
  ...
  getConvenientType = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ConvenientTypeService.get({
  ...
  updateConvenientType = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await ConvenientTypeService.update(
        { convenientTypeId: req.body.convenientTypeId },
        { ...req.body }
      ),
    }).send(res);
