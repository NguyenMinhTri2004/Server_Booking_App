...
class DetailOrderController {
  ...
  getDetailOrder = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await DetailOrderService.get({
        detailOrderId: req.query.detailOrderId,
      }),
    }).send(res);
  };
  ...
  updateDetailOrder = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await DetailOrderService.update(
        { detailOrderId: req.body.detailOrderId },
        { ...req.body }
      ),
    }).send(res);
  };
  ...
  deleteDetailOrder = async (req, res, next) => {
    return new SuccessResponse({
      ...
      metadata: await DetailOrderService.delete({
        detailOrderId: req.body.detailOrderId,
      }),
    }).send(res);
  };
