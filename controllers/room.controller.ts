...
class RoomController {
    ...
    updateRoom  = async (req , res , next) => {
        return new SuccessResponse({
            ...
            metadata : await RoomService.update({roomId : req.body.roomId} , {...req.body})
        }).send(res)
    };
    ...
    deleteRoomType  = async (req , res , next) => {
        return new SuccessResponse({
            ...
            metadata : await RoomTypeService.delete({roomTypeId : req.body.roomTypeId})
        }).send(res)
    };
    ...
    getRoomType  = async (req , res , next) => {
        return new SuccessResponse({
            ...
            metadata : await RoomTypeService.get({roomTypeId : req.query.roomTypeId})
        }).send(res)
    };

    getallRoomType  = async (req , res , next) => {
        return new SuccessResponse({
            message: "Get all RoomType Ok",
            metadata : await RoomTypeService.getAll()
        }).send(res)
    };
    ...
    updateRoomType  = async (req , res , next) => {
        return new SuccessResponse({
            ...
            metadata : await RoomTypeService.update({roomTypeId : req.body.roomTypeId} , {...req.body})
        }).send(res)
    };
}
