...
class CommentController {
    ...
    getallCommentByUserId  = async (req , res , next) => {
        return new SuccessResponse({
            ...
            metadata : await CommentService.get({user : req.query.userId})
        }).send(res)
    };
    ...
    updateComment  = async (req , res , next) => {
        return new SuccessResponse({
            ...
            metadata : await CommentService.update({commentId : req.body.commentId} , {...req.body})
        }).send(res)
    };
    ...
    deleteComment  = async (req , res , next) => {
        return new SuccessResponse({
            ...
            metadata :  await CommentService.delete({commentId : req.body.commentId})
        }).send(res)
    };
}
